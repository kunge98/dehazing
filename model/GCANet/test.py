...
parser.add_argument('--outdir', default='./dehazeing')
...
img = Image.open(test_img_paths[0]).convert('RGB')
im_w, im_h = img.size
...
out_img.save(os.path.join(opt.outdir, os.path.splitext(os.path.basename(test_img_paths[0]))[0] + '_%s.png' % opt.task))
