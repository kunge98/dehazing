...
parser.add_argument('--valBatchSize', type=int, default=2, help='input batch size')
...
parser.add_argument('--outputChannelSize', type=int,
  default=3, help='size of the dehazeing channels')
...
parser.add_argument('--exp', default='sample', help='folder to dehazeing images and model checkpoints')
...
# NOTE: size of 2D dehazeing maps in the discriminator
sizePatchGAN = 30
real_label = 1
fake_label = 0
